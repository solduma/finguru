...
export const STRATEGIES: Strategy[] = [
  ...
  },
  {
    ...
    schools: ["fundamental"],
    steps: [
      concept("investing-basics", "New here? Start with the vocabulary: stock, share, price, dividend, EPS — the words the valuation lessons assume before we estimate what a business is worth.", "여기가 처음인가요? 어휘부터: 주식·주·가격·배당·EPS — 기업 가치를 추정하기 전에 가치평가 레슨이 전제하는 단어들."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund a brokerage account, choose the right account type, and place the order once a stock clears your margin of safety.", "마지막 단계: 증권 계좌를 열고 자금을 넣고, 알맞은 계좌 종류를 고른 뒤, 안전마진을 통과한 종목의 주문을 넣기."),
    ],
  ...
  },
  {
    ...
    steps: [
      concept("investing-basics", "Brand new? Start here: what a stock, earnings, and price mean in plain language — the base every growth idea builds on.", "완전 초보인가요? 여기서 시작: 주식·이익·가격이 쉬운 말로 무엇인지 — 모든 성장 개념이 세워지는 토대."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account, pick a tax-advantaged wrapper, and place the order to actually own the compounder you found.", "마지막 단계: 계좌를 열고 자금을 넣고, 절세 계좌를 고른 뒤, 찾아낸 성장주를 실제로 사는 주문 넣기."),
    ],
  ...
  },
  {
    ...
    schools: ["quant"],
    steps: [
      concept("investing-basics", "New to markets? Start with the vocabulary: stock, index, fund, ETF, and risk — the primitives the factor lessons assume.", "시장이 처음인가요? 어휘부터: 주식·지수·펀드·ETF·위험 — 팩터 레슨이 전제하는 기본 개념."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account and buy the factor ETF you settled on — market vs limit orders, fees, and account type.", "마지막 단계: 계좌를 열고 자금을 넣어 고른 팩터 ETF를 매수하기 — 시장가 대 지정가, 수수료, 계좌 종류."),
    ],
    practical: "factor",
  },
  {
    ...
    schools: ["macro"],
    steps: [
      concept("investing-basics", "New here? Start with the basics: stock, bond, interest rate, and index — the building blocks the macro lessons move around.", "여기가 처음인가요? 기초부터: 주식·채권·금리·지수 — 매크로 레슨이 다루는 기본 요소들."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account, then express your macro view as small, sized tilts you actually place — not leverage.", "마지막 단계: 계좌를 열고 자금을 넣은 뒤, 매크로 관점을 레버리지가 아니라 실제로 넣는 작게 조절된 기울기로 표현하기."),
    ],
    practical: "macro",
  },
  {
    ...
    steps: [
      concept("investing-basics", "Brand new? Start here: what a stock, price, and trade actually are before we test rules for trading them.", "완전 초보인가요? 여기서 시작: 매매 규칙을 시험하기 전에 주식·가격·거래가 실제로 무엇인지."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account, then place the entries and stops your system calls for, with position sizing.", "마지막 단계: 계좌를 열고 자금을 넣은 뒤, 시스템이 요구하는 진입과 손절을 포지션 크기와 함께 실제로 넣기."),
    ],
  ...
  },
  {
    ...
    schools: ["fundamental"],
    steps: [
      concept("investing-basics", "New to all of this? Start with the vocabulary: stock, share, price, and how a trade works — the base under these special situations.", "여기가 처음인가요? 어휘부터: 주식·주·가격과 거래의 작동 방식 — 이 특수 상황들의 토대."),
  ...
  },
  {
    ...
    steps: [
      concept("investing-basics", "New here? Start with the basics: stock, dividend, yield, and fund — the words the REIT and real-asset lessons assume.", "여기가 처음인가요? 기초부터: 주식·배당·수익률·펀드 — 리츠와 실물자산 레슨이 전제하는 단어들."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account, choose the account type, and buy the REIT or real-asset fund you judged worth owning.", "마지막 단계: 계좌를 열고 자금을 넣고, 계좌 종류를 고른 뒤, 보유할 가치가 있다고 판단한 리츠·실물자산 펀드를 매수하기."),
    ],
  ...
  },
  {
    ...
    schools: ["technical", "quant"],
    steps: [
      concept("investing-basics", "Brand new to investing? Start here first: stock, share, price, and dividend — you need these before options make any sense.", "투자가 완전 처음인가요? 먼저 여기서: 주식·주·가격·배당 — 옵션을 이해하려면 이것들이 먼저 필요합니다."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account and get the right approval level — then place the covered call or cash-secured put you planned.", "마지막 단계: 계좌를 열고 자금을 넣고 알맞은 승인 등급을 받은 뒤, 계획한 커버드콜이나 현금담보풋을 실제로 넣기."),
    ],
    practical: "options",
  },
  {
    ...
    schools: ["technical"],
    steps: [
      concept("investing-basics", "New here? Start with the vocabulary: stock, price, order types, and risk — the primitives before any active trading.", "여기가 처음인가요? 어휘부터: 주식·가격·주문 유형·위험 — 능동적 매매에 앞선 기본 개념."),
      ...
      concept("placing-your-first-trade", "The last mile: open and fund the account, set order types and position sizing, and place the trade with your loss defined first.", "마지막 단계: 계좌를 열고 자금을 넣고, 주문 유형과 포지션 크기를 정한 뒤, 손실을 먼저 정한 채 거래를 넣기."),
    ],
