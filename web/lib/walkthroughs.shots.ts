...
export const EDGAR_CASHFLOW_SHOT: SourceShot = {
  ...
  markers: [
    ...
    },
    {
      ...
      h: 2.2,
      label: {
        en: "Cash generated by operating activities = operating cash flow (OCF), the total of the Operating section. The first term of FCF.",
        ko: "Cash generated by operating activities = 영업활동현금흐름(OCF), 영업 구간의 합계. FCF의 첫 항.",
      },
    },
    {
      n: 3,
      ...
      h: 2.2,
      label: {
        en: "Payments for acquisition of property, plant and equipment = CAPEX (in the Investing section, shown negative). FCF = OCF − CAPEX.",
        ko: "Payments for acquisition of property, plant and equipment = CAPEX(투자활동 구간, 음수). FCF = OCF − CAPEX.",
      },
    },
    {
      n: 4,
